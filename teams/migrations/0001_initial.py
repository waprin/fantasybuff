    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('week', models.IntegerField()),
                ('lineup_average', models.DecimalField(null=True, max_digits=7, decimal_places=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delta', models.DecimalField(default=None, null=True, max_digits=7, decimal_places=4)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('espn_user', models.ForeignKey(to='teams.EspnUser', null=True)),
                ('league', models.ForeignKey(to='teams.League')),
            ],
            options={
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('average_lineup_score', models.DecimalField(null=True, max_digits=7, decimal_places=4)),
                ('average_draft_score', models.DecimalField(max_digits=7, decimal_places=4)),
                ('average_waiver_score', models.DecimalField(max_digits=7, decimal_places=4)),
                ('average_trade_score', models.DecimalField(max_digits=7, decimal_places=4)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('waiver_score', models.DecimalField(max_digits=7, decimal_places=4)),
                ('trade_score', models.DecimalField(max_digits=7, decimal_places=4)),
                ('lineup_score', models.DecimalField(null=True, max_digits=7, decimal_places=4)),
                ('week', models.IntegerField()),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('date', models.DateField()),
                ('other_team', models.ForeignKey(related_name=b'other_team', to='teams.Team')),
